...
import { useDeleteBookMutation, useGetBooksQuery } from "../app/redux/features/book/bookApi";
                ...
                <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-gray-500 space-x-2">
                      ...
                      <button className="deleteBook" onClick={() => deleteBook(book?._id)}>
                        <svg
                          fill="none"
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
                  ...
                  <div className="space-y-2 mt-4 h-full">
                    ...
                    {/* <div className="stars">
                      {[...Array(parseInt(book.rating)).keys()].map(
                        (star, id) => (
                          <svg
                            key={id}
                            viewBox="0 0 20 20"
