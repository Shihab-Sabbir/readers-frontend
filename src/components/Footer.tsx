...
export default function Footer() {
  ...
  return (
    <footer className="py-6 dark:bg-gray-800 dark:text-gray-50 bg-[#928AEE]">
      <div className="flex items-center justify-around w-full px-10">
        <div className="">
          <div className="pb-6 col-span-full w-fit">
            <Link to="/">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <div className="flex gap-2 text-xs font-semibold ">
              <Link to="/all-books" className="cursor-pointer">
                All books
              </Link>
              {!!token && (
                <>
        ...
        <div className="grid justify-center pt-6">
          <div className="flex flex-col self-center text-sm text-center">
